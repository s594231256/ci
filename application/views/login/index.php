...
<html lang="en">
    <head>
        ...
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?echo base_url()?>include/bootstrap/assets/ico/apple-touch-icon-144-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?echo base_url()?>include/bootstrap/assets/ico/apple-touch-icon-114-precomposed.png">
