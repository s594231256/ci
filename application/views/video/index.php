<div>
<form role="form" action="<?php echo site_url('video/create')?>" method="post" class="login-form">
  <div class="col-md-2">
  ...
  <div class="form-group col-md-5" style="margin-top: 22px;">
    ...
    <?php if($user_type == 1){?>
    <a style="margin-left: 22px;" class="btn btn-success" href="<?php echo site_url('video/create')?>">新增</a>
    <?php }?>
  </div>
</form>
</div>
...
<table class="table table-bordered">
  ...
  <tr class="active">
    ...
    <?php if($v['video_status'] == 1){ ?>
      <a  class="btn btn-primary btn-xs btn-sm" href="<?php echo site_url('video/watch?id='.$v['id'])?>" >观看</a>&nbsp;
      <?php
        if($user_type == 1)
        {
